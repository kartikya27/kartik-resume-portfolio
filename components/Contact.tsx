    ...
    <section id="contact" className="py-20 bg-white dark:bg-dark-bg">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-800 dark:text-gray-300 max-w-2xl mx-auto mb-12">
          I'm currently open to new opportunities and collaborations. My inbox is always open. Whether you have a question or just want to say hi, I'll try my best to get back to you!. <b> For Quick connect please call on +91 9828051996</b>
        </p>
